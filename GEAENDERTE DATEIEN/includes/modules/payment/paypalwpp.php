 ...
 * @version $Id: paypalwpp.php Zen Cart 1.5.4 ohne Überschreiben der Lieferadresse 2016-03-12 22:12:14Z webchills $
 */
/**
...
//    }
  ...
  function ec_step1() {
    ...
    $options['ALLOWNOTE'] = 0;  // allow customer to enter a note on the PayPal site, which will be copied to order comments upon return to store.
